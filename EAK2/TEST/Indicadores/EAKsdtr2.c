...
double pivotT1 = iCustom(Symbol(),PERIOD_M5,"Pivot_Voty",43200,10,0);//43200 10080 1440
double pivotB1 = iCustom(Symbol(),PERIOD_M5,"Pivot_Voty",43200,11,0);
double pivotN1 = iCustom(Symbol(),PERIOD_M5,"Pivot_Voty",43200,3,0);

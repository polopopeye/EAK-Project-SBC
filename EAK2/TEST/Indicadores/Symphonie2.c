...
//RECOMENDADO M30
    double ExtremeC = iCustom(Symbol(),PERIOD_M30,"Symphonie_Extreme_Cycle_Indikator",1,1);
    double ExtremeV = iCustom(Symbol(),PERIOD_M30,"Symphonie_Extreme_Cycle_Indikator",2,1);

...
extern color   EP_Level_Label                = C'094,150,253';
extern color   EP_Level_Line                 = C'064,133,208';
extern color   AV_Level_Label                = C'205,072,238';
extern color   AV_Level_Line                 = MediumOrchid;
extern color   SL_Level_Label                = C'255,032,032';
extern color   SL_Level_Line                 = C'226,035,035';
extern color   TP_Level_Label                = C'046,186,046';
extern color   TP_Level_Line                 = C'015,168,084';
extern color   EP_Dot_Long                   = C'028,199,255';
extern color   EP_Dot_Short                  = C'255,128,128';
extern color   EP_Dot_Center                 = Black;
extern color   EP_Dot_Closed                 = White;
extern color   CP_Dot_Center                 = Black;
extern color   CP_Dot_Closed                 = Yellow;
extern int     Dot_Size_12345                = 2;
extern color   PL_Line_Trade_Positive        = C'028,199,255';
extern color   PL_Line_Trade_Negative        = C'255,128,128';
extern color   PL_Label_Background           = C'230,227,138';

...
if(sentiment>53||sentiment==53){
 ...
 cocientecompra=1;
 cocienteventa=0;
 cocientesentimentcompra=0.0125;
...
if(OrderType()==OP_SELL){
 ...
 if(tiempoelapsedS>ordersElapsedC){//mas de 1 semana cierre aunque sea con perdidas pero solo si el sentimiento lo dice
   if(cierresemafortend==1&&closesemafororders==true&&keepordersentimentS==0&&sentimentkeepposition==true)OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
 }
 ...
 if(tiempoelapsedS>ordersElapsedB){//MAS DE 3 Dias cierre desesperado sin perdidas
   ...
   if(DiffPipsv1>minpositionallowedtoclosepipsc){
     if(closeallordersv==1&&autotakeprofit2==true&&keepordersentimentS==0&&sentimentkeepposition==true){
     ...
     if(autotkpfcierreV==1&&autotakeprofit==true&&keepordersentimentS==0&&sentimentkeepposition==true){
       if(cierresemafortend==1&&closesemafororders==true){
         OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
       }else{
         OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
     ...
     if(cierresemafortend==1&&closesemafororders==true&&profitordersV>0&&tiempoelapsedS<ordersElapsedC&&keepordersentimentS==0&&sentimentkeepposition==true){
       OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
 ...
 if(tiempoelapsedS>ordersElapsedA&&tiempoelapsedS<ordersElapsedB){//ENTRE 1 y 3 dias.
   ...
   if(DiffPipsv1>minpositionallowedtoclosepipsb){
     ...
     if(cierresemafortend==1&&closesemafororders==true&&profitordersV>0&&keepordersentimentS==0&&sentimentkeepposition==true){
      OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
       if(optimizelucky==true&&luckymethod==1){
...
if(tiempoelapsedB>ordersElapsedC){
  if(cierresemafortend==2&&closesemafororders==true&&keepordersentimentC==0&&sentimentkeepposition==true)OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
}

if(tiempoelapsedB>ordersElapsedB){//MAS DE 3 Dias
  gridpositionC=gridposition/8;
  if(DiffPipsc1>minpositionallowedtoclosepipsc){
    if(closeallordersc==1&&autotakeprofit2==true&&keepordersentimentC==0&&sentimentkeepposition==true){
    ...
    if(autotkpfcierreC==1&&autotakeprofit==true&&keepordersentimentC==0&&sentimentkeepposition==true){
      if(cierresemafortend==2&&closesemafororders==true){
        OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
      }else{
        OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
    ...
    if(cierresemafortend==2&&closesemafororders==true&&profitordersC>0&&tiempoelapsedB<ordersElapsedC&&keepordersentimentC==0&&sentimentkeepposition==true){
OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
      if(optimizelucky==true&&luckymethod==1){
...
gridpositionC=gridposition/4;
  if(DiffPipsc1>minpositionallowedtoclosepipsb){
    ...
    if(cierresemafortend==2&&closesemafororders==true&&profitordersC>0&&keepordersentimentC==0&&sentimentkeepposition==true){
      OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
      if(optimizelucky==true&&luckymethod==1){
...
ObjectSetText(Symbol()+"filter1","filter1c: ["+filter1c+"]   filter1v:["+filter1v+"]",7,NULL,Orange);
  ...
  ObjectSet(Symbol()+"filter1",OBJPROP_YDISTANCE,200);
   ...
   if(TotalOrdersCount()>=0&&TotalOrdersCount()<199)
     {
if(sentimentind==true&&sentiment!=NULL){

...
void start() {
   ...
   if (ShowCurrencies && (!CurrenciesWindowBelowTable)) {
      ...
      f0_2("hdTxt", "Window", 69, "EAK V1-3", "Courier new", g_color_236, 0, 34, -2, 0, 11);
   } else {
      f0_11("Window", "", 30, 4, 18, 11, 1, 0, g_color_216, g_color_216, 0, 0, 0);
      f0_2("hdTxt", "Window", 69, "EAK V1-3", "Courier new", g_color_236, 0, 1, -2, 0, 11);
   }
   int li_16 = 14;
   li_24 = 2;
      ...
      if (StringFind(DontShowThisPairs, gsa_196[index_0]+accounttype) < 0) {
         ...
         if (li_40 >= 0) {
            ...
            if (gda_212[index_0][0] < 0.0) {
              if(gda_212[index_0][0]<-85){

                //----------------------------------
                string fileHandlesimeter2 = FileOpen(fileNamesimeter,FILE_WRITE);//|FILE_READ| FILE_WRITE
                ...
                //----------------------------------
                string fileHandlesimeter3 = FileOpen(fileNamesimeter,FILE_WRITE);//|FILE_READ| FILE_WRITE
              ...
              if(gda_212[index_0][0]>85){
                ...
                //----------------------------------
                string fileHandlesimeter1 = FileOpen(fileNamesimeter,FILE_WRITE);//|FILE_READ| FILE_WRITE
                ...
                //----------------------------------
                string fileHandlesimeter4 = FileOpen(fileNamesimeter,FILE_WRITE);//|FILE_READ| FILE_WRITE

...
if(OrderType()==OP_SELL){
 ...
 if(cierresemafortend==1&&closesemafororders==true&&profitordersV>0)OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);//Aqui
...
if(cierresemafortend==2&&closesemafororders==true&&profitordersC>0)OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Blue);//Aqui
